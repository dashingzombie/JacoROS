...
def main():
    ...
    joint_state_define_file = open(path_to_src + '/kinova_optimization_core/config/joint_state_define_functions/' + joint_state_define_file_name, 'r')
    joint_state_define = joint_state_define_file.read()

    urdf_file = open(path_to_src + '/kinova_optimization_core/config/urdfs/' + urdf_file_name, 'r')
